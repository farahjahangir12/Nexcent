        ...
        <>
            <section className="text-container mt-3 mb-4 pt-4">
                ...
                <div className="d-flex justify-content-center">
                    <p className="w-50 text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae tempore officia ad fugit dicta doloribus maxime    
                     deserunt recusandae in, natus dolores at, illo molestiae. Minus provident error incidunt molestiae architecto!</p>
                </div>
                </section>
            <section className="d-flex flex-column flex-md-row justify-content-evenly align-items-center">
